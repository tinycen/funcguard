...
| 功能模块 | 说明 | 详细文档 |
|----------|------|----------|
| **数据填充** | 空值填充、四舍五入 | [fill.md](./pandas/fill.md) |
| **日期时间** | NaT 时间填充、日期差值计算 | [date.md](./pandas/date.md) |
| **类型转换** | 列类型转换、Series 数值转换、Decimal 转换、日期时间转换、Series 格式转换 | [convert.md](./pandas/convert.md) |
| **数据格式化** | 字符串格式化 | [format.md](./pandas/format.md) |
